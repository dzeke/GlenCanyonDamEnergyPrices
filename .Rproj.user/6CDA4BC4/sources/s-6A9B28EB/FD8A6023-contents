...
#       3. Convert the Generation table to Narrow format. So the first table has Columns of [Month][Trace][Hour][Generation]
#       4 Convert the Econ table to Narrow format. So the second table has Columns of [Month][Trace][Hour][Value]
#
#       5. Join the two tables on Month, Trace, and Hour so we have a new data frame with columns [Month][Trace][Hour][Generation][Value]
#
